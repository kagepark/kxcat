...
xcat_install() {
  ...
  yum -y install dhcp dhcp-common dhcp-libs ntp nfs httpd tftp bind screen rpcbind bind-utils wget git openssl openssl-libs sqlite pigz ipmitool net-tools quota-nls quota 
